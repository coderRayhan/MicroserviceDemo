...
public class SeedingData
{
    ...
    public SeedingData(MongoDbSettings dbSettings)
    {
    ...
    public void Seed()
    {
        var data = _database.GetCollection<Product>(nameof(Product)).Find(_ => true).FirstOrDefault();
        if(data == null)
        {
            ...
            _database.GetCollection<Product>(nameof(Product)).InsertMany(list);
        }
    }
}
